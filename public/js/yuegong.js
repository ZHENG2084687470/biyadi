define(function(require, exports, module) {
	...
	$(".xf-select ul li").mouseenter(function(){
		...
		//填充总价格
		$("#label_price").html("<p><strong>"+ zongjia +"</strong>万元</p>");
	...
	function jisuan(){
		...
		if(loantype < 4){
			...
			var lilv_sd = lilv_array[31][1][years]; //尊融易贷购车方案
			var lilv_gjj = lilv_array[31][2][years]; //无忧贷购车方案
	
			
			var daikuan_sy = $("#val_loanbussiness").val(); //尊融易贷购车方案总额
			var daikuan_gjj = $("#val_loanfund").val(); //无忧贷购车方案总额
		...
		$(".legend-rate span").html("支付利息："+lixi+"万<em><br>（利率"+Math.round(lilv_array[31][2][years]*10000)/100+"%，商业性"+Math.round(lilv_array[31][1][years]*10000)/100+"%）</em>");
